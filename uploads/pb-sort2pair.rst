.. parsonsprob:: pb-sort2pair
  ...
  =====
  Compute PAIRING on its input. The result is (\textbf{SLN'}), an array of paired records, where each such paired record is defined as (()pos, pairedInput). #tag:pairing; depends:pairingin;
  =====
