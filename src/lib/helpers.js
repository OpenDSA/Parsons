...
let currentFileName = document.getElementsByClassName("parsons")[0].id;
...
export function getLoadedFileName() {
    if(currentFileName === "pa-ex1") currentFileName="pa-ex-1.rst"
...
export function loadFile() {
    $("#submit-btn").click(function(event){
        ...
        reader.onload = function () {
            ...
            injectHTML(parsed)
            console.log("loaded")
            clearEventLogs(inputFile.name, new Date().toISOString())//whenever a new exercise is loaded the event logs are cleared
